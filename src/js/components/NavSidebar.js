      ...
      <Sidebar id="sidebar" direction="column" background="background-contrast"
               ...
               footer={
                 <Box justify="end" align="end" direction="column"  full="horizontal">
                   <Box tag='label'><Text size="xsmall">POC APP GUI: v{version.version}</Text></Box>
                   { this.state.serverConnected && (
                       <Box tag='label'><Text size="xsmall">POC Server: v{this.state.serverVersion}</Text></Box>
                   )}
                   { !this.state.serverConnected && (
                       <Box tag='label'><Text size="xsmall">BMA Server: Not connected</Text></Box>
                   )}
                 </Box>
